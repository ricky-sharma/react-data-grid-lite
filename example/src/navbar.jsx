    ...
    return (
        <nav className="navbar">
            ...
            <ul className={`navbar-links ${isOpen ? 'open' : ''}`}>
                ...
                <li><Link to="/Grid6" onClick={() => setIsOpen(false)}>Column Drag-Drop</Link><span></span></li>
                <li><Link to="/Grid5" onClick={() => setIsOpen(false)}>Pinned &amp; Resizable Columns</Link><span></span></li>
